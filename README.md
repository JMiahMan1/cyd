...
- **Remote page control** — ESPHome API services (`show_page`, `show_dlg`, `set_playlists`, `set_weather`) let Home Assistant drive the display
...
- ESP32-2432S028 (CYD): ESP32-WROOM, 2.8" 320x240 ILI9342 SPI display, XPT2046 resistive touch
- PWM backlight + RGB case LED
- 3D printed case (files in `3D Print/`)
